...
if(user.start == true){
let time: number = 0; // Declare easy outside the interval function
...
let es:string = "Quick Brown Fox Jumps Over The Lazy Dog"
...
let m :string = "Quick Brown Fox Jumps Over The Lazy Dog";
let e :string =   "quick brown fox jumps over the lazy dog"
...
if(s.st === "login"){
    ...
    let pass :number = 12390
        ...
        if(user1.star == true){
        let times: number = 0; // Declare easy outside the interval function
